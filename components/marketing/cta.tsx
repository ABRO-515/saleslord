...
export function CTA() {
  return (
    <Section
      ...
      containerClassName=""
    >
      <div className="relative overflow-hidden rounded-3xl border border-border bg-bg-2/40 px-8 py-12 shadow-[0_30px_80px_rgba(0,0,0,0.35)] backdrop-blur sm:px-12">
